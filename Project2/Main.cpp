...
int main() {
	...
	cout << "При работе с калькультором важно учесть:" << endl;
	cout << "1.Значение размера стороны квадрата не может быть отрицательным;" << endl << "2.Калькулятором предусмотрено решение только трех указанных параметров;" << endl << endl;
